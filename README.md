# OMOIKA: Official Default Plugins
...
The official default plugin collection for [OMOIKA](https://github.com/omoika-institute/plugins). A graph-based, local-first OSINT platform for recon, link analysis, and open-source investigations.

This repository contains the default **entities** (node types) and **transforms** (graph/data operations) that ship with OMOIKA. It is built on top of the [`omoika`](https://github.com/omoika-institute/plugins) [framework](https://github.com/omoika-institute/plugins) package.
...
Both entities and transforms are built with the `omoika` framework package. See the [framework README](https://github.com/omoika-institute/plugins/blob/main/README.md) and its [docs/](https://github.com/omoika-institute/plugins/blob/main/docs/getting-started.md) for the full API reference.
...
- [OMOIKA Releases](https://github.com/omoika-institute/plugins/releases)
- [Plugins Repository](https://github.com/omoika-institute/plugins)
- [Plugins Issue Tracker](https://github.com/omoika-institute/plugins/issues)
- [Electron Issue Tracker](https://github.com/omoika-institute/plugins/issues)
- [Framework Issue Tracker](https://github.com/omoika-institute/plugins/issues)
...
Browser automation: Uses selenium
Network dependencies: Transforms appear to use network-facing modules: httpx, selenium, socket, urllib
